...
public class JPhoneBook extends JFrame {
		...
		}
		{
			...
			}
			{
				...
				}
				{
					...
					bottomPanel.add(lblAddress, gbc_lblAddress);
				}
				{
					...
					gbc.gridx = 1;
					gbc.gridy = 5;
					bottomPanel.add(m_addressTextField, gbc);
				}
			}
		}
		initDataBindings();
	...
	protected void initDataBindings() {
		...
		//
		BeanProperty<Person, String> personBeanProperty_5 = BeanProperty.create("address");
		jTableBinding.addColumnBinding(personBeanProperty_5).setColumnName("Address");
		//
		...
		autoBinding_7.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_5 = BeanProperty.create("selectedElement.address");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_5 = BeanProperty.create("text");
		AutoBinding<JTable, String, JTextField, String> autoBinding_8 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty_5, m_addressTextField, jTextFieldBeanProperty_5);
		autoBinding_8.bind();
	}
}