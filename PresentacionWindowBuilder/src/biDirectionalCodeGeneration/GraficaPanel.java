...
* @version 	1.0.0
*/
package biDirectionalCodeGeneration;
	...
	//atributos privados de la clase
	  ...
	  public void paintComponent(Graphics g) {
		    ...
		    if (isVector()) {
		    	...
		    	g.drawLine(getVectorXB(), getVectorYB(), getVectorXB(), (getVectorYB() + 12));
		    	g.drawLine(getVectorXB(), getVectorYB(), (getVectorXB() - 12), getVectorYB());
		    }
